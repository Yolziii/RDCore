...
import 'mocha';
import {Config, DieType, CellType, IPlayableCardCell, IPlayerCard, IDie, IServiceCardCell} from "../src/gameplay";
...
describe('Cells', () => {
    ...
    describe('Playable cells', () => {
        describe('NumberCell', () => {
            it('NumberCell', () => {
                ...
                let cell:IPlayableCardCell = new NumberCell(CellType.Ones, 1);
                cell.setDice(dice);
        ...
        describe('RoyalDiceCell', () => {
            it('RoyalDice - 50', () => {
                let dice:Dice = new Dice( die1(), die1(), die1(), die1(), die1());
                let cell:IPlayableCardCell = new RoyalDiceCell();
                cell.setDice(dice);
        ...
        describe('ChanceCell', () => {
            it('Chance - 15', () => {
                let dice:Dice = new Dice(die1(), die2(), die3(), die4(), die5());
                let cell:IPlayableCardCell = new ChanceCell();
                cell.setDice(dice);
        ...
        describe('KindsCell', () => {
            it('3 Kind - 7', () => {
                let dice:Dice = new Dice(die1(), die1(), die1(), die2(), die2());
                let cell:IPlayableCardCell = new KindCell(CellType.Kind3, 3);
                cell.setDice(dice);
                assert.equal(cell.value(), 7);
            });

            it('3 Kind type', () => {
                let cell:IPlayableCardCell = new KindCell(CellType.Chance, 3);
                assert.equal(CellType.Chance, cell.type);
            });
            ...
            it('4 Kind - 6', () => {
                let dice:Dice = new Dice(die1(), die1(), die1(), die1(), die2());
                let cell:IPlayableCardCell = new KindCell(CellType.Kind4, 4);
                cell.setDice(dice);
        ...
        describe('FullHouseCell', () => {
            it('FullHouseCell - 25', () => {
                let dice:Dice = new Dice(die1(), die1(), die2(), die2(), die2());
                let cell:IPlayableCardCell = new FullHouseCell();
                cell.setDice(dice);
            ...
            it('FullHouseCell - 0', () => {
                let dice:Dice = new Dice(die1(), die1(), die2(), die2(), die3());
                let cell:IPlayableCardCell = new FullHouseCell();
                cell.setDice(dice);
                assert.equal(cell.value(), 0);
            });
        ...
        describe('StraightsCell', () => {
            it('SmallStraight - 30', () => {
                let dice:Dice = new Dice(die2(), die3(), die1(), die4(), die6());
                let cell:IPlayableCardCell = new StraightCell(CellType.SmallStraight, Config.CostSmallStraight, 4);
                cell.setDice(dice);
            ...
            it('SmallStraight - 0', () => {
                let dice:Dice = new Dice(die2(), die3(), die1(), die5(), die6());
                let cell:IPlayableCardCell = new StraightCell(CellType.SmallStraight, Config.CostSmallStraight, 4);
                cell.setDice(dice);
                assert.equal(cell.value(), 0);
            });
            ...
            it('LargeStraight - 40', () => {
                let dice:Dice = new Dice(die2(), die3(), die1(), die4(), die5());
                let cell:IPlayableCardCell = new StraightCell(CellType.LargeStraight, Config.CostLargeStraight, 5);
                cell.setDice(dice);
    ...
    describe('Service cells', () => {
        ...
        describe('TotalNumbersCell', () => {
            ...
            it("Zero", () => {
                let totalNumbers:IServiceCardCell = card.getCellService(CellType.ServiceTotalNumbers);
        ...
        describe('Bonus63Cells', () => {
            ...
            it("Zero", () => {
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceBonus63);
                assert.equal(bonus.value(), 0);
            });
            ...
            it("Full bonus", () => {
                ...
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceBonus63);
                assert.equal(bonus.value(), Config.CostBonus63);
            });
        });
        ...
        describe('TotalNumbersWithBonusCell', () => {
            ...
            it("Zero", () => {
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceTotalNumbersWithBonus);
                assert.equal(bonus.value(), 0);
            });
            ...
            it("Full bonus", () => {
                ...
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceTotalNumbersWithBonus);
                assert.equal(bonus.value(), Config.CostBonus63 + 63);
            });
        ...
        describe('Top points', () => {
            ...
            it("Zero", () => {
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceTopPoints);
                assert.equal(bonus.value(), 0);
            });
        ...
        describe('Bottom points', () => {
            ...
            it("Zero", () => {
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceBottomPoints);
                assert.equal(bonus.value(), 0);
            });

            it("Just playable values", () => {
                card.getCellPlayable(CellType.Kind3).setDice(new Dice(die1(), die1(), die1(), die2(), die2())); // 3 + 4 = 7;
                card.getCellPlayable(CellType.Kind4).setDice(new Dice(die1(), die1(), die1(), die1(), die2())); // 4 + 2 = 6;
                ...
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceBottomPoints);
                assert.equal(bonus.value(), 7 + 6 + Config.CostFullHouse + Config.CostSmallStraight + Config.CostLargeStraight + Config.CostRoyalDice + 15);
            });
        ...
        describe('BonusRoyal', () => {
            ...
            it("Zero", () => {
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceBonusRoyal);
                assert.equal(bonus.value(), 0);
            });
            ...
            it("All royaldices", () => {
                ...
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceBonusRoyal);
                assert.equal(bonus.value(), Config.CostRoyalBonusPerItem * 12);
            });
        ...
        describe('Total bonuses', () => {
            ...
            it("Zero", () => {
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceTotalBonuses);
                assert.equal(bonus.value(), 0);
            });
            ...
            it("Both bonuses", () => {
                ...
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceTotalBonuses);
                assert.equal(bonus.value(), Config.CostBonus63 + Config.CostRoyalBonusPerItem);
            });
        });
        ...
        describe('Final score', () => {
            ...
            it("Zero", () => {
                let bonus:IServiceCardCell = card.getCellService(CellType.ServiceFinalScore);
                assert.equal(bonus.value(), 0);
            });
            ...
            it("All Points", () => {
                ...
                assert.equal(
                    bonus.value(),
                    63 + Config.CostBonus63 + 7 + 6 + Config.CostFullHouse + Config.CostSmallStraight + Config.CostLargeStraight + Config.CostRoyalDice + 30 +  Config.CostRoyalBonusPerItem);
            });
        });
    });
});
